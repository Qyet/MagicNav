...
export async function POST(request: Request) {
  ...
  if (processedIcon && processedIcon.includes('logo.clearbit.com')) {
    const domain = new URL(processedIcon).pathname.replace('/', '');
    processedIcon = `https://img.logo.dev/${domain}?token=pk_XMRLa6d_THicc0IUVsTg1A`;
  }
