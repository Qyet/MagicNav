...
export async function GET(request: Request) {
  try {
    ...
    // Define where clause based on user session and publicOnly parameter
    const whereClause = publicOnly || !session ? {
      isPublic: true
    } : undefined;
    
    // Retrieve collections list, with appropriate access control
