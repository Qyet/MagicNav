  ...
  return (
    <>
      <div className="relative group">
        ...
        <Card onClick={handleClick} className="relative cursor-pointer hover:-translate-y-2 transition-all rounded-3xl bg-gradient-to-b from-white to-gray-50/50 border-gray-200">
